...
public class ConsolaOlimpicos
{
	...
	/**
	 * Este metodo sirve para ejecutar el metodo que te permite saber a que pais pertenece un atleta y lo imprime.
	 */
	private void ejecutarDarPaisAtleta() 
	{
		System.out.println("\n" + "País de un atleta" + "\n");
		...
		if (pais == null)
			System.out.println("No se encontró el atleta");
		else
